...
LittleBall::LittleBall(sf::RenderWindow* window, float velocity, GameManager* gameManager)
...
void LittleBall::update(float dt)
{
...
void LittleBall::render()
{
    _window->draw(_sprite);
}

void LittleBall::setVelocity(float coeff, float duration)
{
    _velocity = coeff * VELOCITY;
    _timeWithPowerupEffect = duration;
}

void LittleBall::setFireBall(float duration)
{
    if (duration)
    {
        _isFireBall = true;
