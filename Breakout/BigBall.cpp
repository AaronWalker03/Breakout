...
BigBall::BigBall(sf::RenderWindow* window, float velocity, GameManager* gameManager)
...
void BigBall::setVelocity(float coeff, float duration)
{
    _velocity = coeff * VELOCITY;
    _timeWithPowerupEffect = duration;
}

void BigBall::setFireBall(float duration)
{
    if (duration)
    {
        _isFireBall = true;
